...
Since there is no official release on the Chrome Web Store yet, you will need to unpack manually.

## Usage
1. Navigate to either [ChatGPT](https://chatgpt.com) or [Google Gemini](https://gemini.google.com).
2. Click on the **Wider-Chatbots** extension icon in your browser toolbar.
3. Use the slider in the popup to dynamically adjust the width of the main chat container to your liking!
